...
| ABlog / sphinx-design / sphinx-copybutton / sphinx-togglebutton integration | Not applicable | These are Sphinx extensions. Hugo handles equivalent needs (blogging, callouts, code-copy buttons) through its own content/shortcode mechanisms, outside this theme's scope. |
